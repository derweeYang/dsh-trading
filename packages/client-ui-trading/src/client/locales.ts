...
export const en: Record<MarketLocaleKey, string> = {
      ...
      'options.spotLinkHint': 'Options link to the ETF spot: view the underlying, trade the spot, or hand the contract to the Agent to order',
