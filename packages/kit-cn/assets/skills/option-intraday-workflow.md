...
2. 同源双挂先合并再留一只（链更厚者）：`588000`/`588080`。箱体行的 `twinUnderlying` 是权威对侧（2026-09-13 起 510300/510500 下架，300/500 双挂对已移除）。
...
**提案者**：`opportunity`+`edge` → 制度假设 → 为何此模板 → 行权价相对箱体 → 失效条件（抄 `invalidIf`）→ `playbook` / 义务仓 / 乘数 10000。
